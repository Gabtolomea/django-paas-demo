# Generated by Django 4.0.6 on 2022-09-12 03:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statuscode', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='index.status')),
            ],
        ),
        migrations.CreateModel(
            name='BarangayRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('', '')], max_length=20)),
